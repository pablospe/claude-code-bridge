# Milestone 1: Channels-in / MCP-tools-out vertical slice

> Status: **shipped.** This document was the original design and scope doc for the project's first milestone. It is kept as historical reference; the durable conceptual overview is in [ARCHITECTURE.md](./ARCHITECTURE.md) and the milestone index is in [ROADMAP.md](./ROADMAP.md).
